        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EventId = table.Column<int>(type: "int", nullable: false),
                    EventAssignmentId = table.Column<int>(type: "int", nullable: false),
                    DateAssigned = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventAssignments", x => new { x.EventId, x.UserId });
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EventAssignments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CriteriaId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CriteriaName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CriteriaPercentage = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Criteria_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Criteria_EventCategories_EventCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Scores", x => new { x.CandidateId, x.JudgeId, x.CriteriaId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Scores_EventCategories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Candidates_YearId",
                table: "Candidates",
                column: "YearId");

            migrationBuilder.CreateIndex(
                name: "IX_Criteria_ApplicationUserId",
                table: "Criteria",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Criteria_EventCategoryId",
                table: "Criteria",
                column: "EventCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_EventAssignment_UniqueAssignment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventAssignments_UserId",
                table: "EventAssignments",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Scores_CandidateId_JudgeId_CriteriaId",
                table: "Scores",
                columns: new[] { "CandidateId", "JudgeId", "CriteriaId" },
                unique: true);
